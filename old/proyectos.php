        ...
        <div class="ms-right">
            ...
            <!-- RIGHT 2 -->
                ...
                <?php echo '<div class="ms-section show-mobile" id="right'. $counter . ' style="height: 100%; background-color: rgb(255, 255, 255);">'; 
                    ...
                    echo '</div>';
                    echo '</div>';
                    echo '<div class="ms-tableCell" style="height: 650px">';
                            ...
                            <div class="border"></div>
                                    ...
                                    <?php
                                     ...
                                     if( $images ):?>
                                      ...
                                      <a class="design-popup-link-<?php echo $counter ?> mfp-fade" href="<?= $image['url']; ?>">
...
$(document).ready(function() {
    ...
    <?php $h = 2;?>
                    <?php if( have_rows('lista_de_proyectos', 26) ): ?>
						...
						echo " $('.design-popup-link-". $h  ."').magnificPopup({
					       type:'image',
