...
<head>
    ...
    <meta http-equiv="refresh" content="3;url=http://www.rogervalerio.net/contactenos.html">
...
<div align="center">
	...
	<div class="infotxt">
    	...
    	<div class="texto">
            ...
            <p><strong>Dirección:</strong><br><br>Iglesia El Carmen, 1c. al Oeste, 75 vrs. al Sur<br /><br>
                <strong>Tel&eacute;fonos:</strong><br><br>2268-0530 / 2264-3082</p>
            </div>
            <div style="float:left; margin-left:30px; width:10px; height:200px;">
      			<img src="images/div-s.png" width="10" height="300" />
            </div>
            <div align="left" style="float:left; width:250px; height:200px; margin-left:30px; margin-top:10px;">
          		<?php
					...
					$destinatario = 'ventas@rogervalerio.net';
					$asunto = 'Contacto - Web Roger Valerio';
					$cuerpo =	'<p><b>Nombre:</b> ' .$nombre. ' <br><b>Celular:</b> ' .$celular. ' <br><br><b>Mensaje:</b><br>' .$mensaje. '</p>';
					...
					$headers .= 'Bcc: rcsozan@gmail.com'."\r\n";
					
					mail($destinatario,$asunto,$cuerpo,$headers);
				?>
                <img src="images/email.png" width="250" height="100" />
            </div>
        </div>
    </div>
    <div class="div-pie">
